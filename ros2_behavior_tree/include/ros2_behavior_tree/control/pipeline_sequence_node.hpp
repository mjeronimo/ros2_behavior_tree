...
#ifndef ROS2_BEHAVIOR_TREE__CONTROL__PIPELINE_SEQUENCE_NODE_HPP_
#define ROS2_BEHAVIOR_TREE__CONTROL__PIPELINE_SEQUENCE_NODE_HPP_
 ...
 */
class PipelineSequenceNode : public BT::ControlNode
{
public:
  explicit PipelineSequenceNode(const std::string & name)
  : BT::ControlNode(name, {})
  {
  }

  PipelineSequenceNode(const std::string & name, const BT::NodeConfiguration & config)
...
#endif  // ROS2_BEHAVIOR_TREE__CONTROL__PIPELINE_SEQUENCE_NODE_HPP_
